...
const file_service_simplebank_proto_rawDesc = "" +
	"\n" +
	"\x18service_simplebank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto2\xfd\x02\n" +
	"\n" +
	"SimpleBank\x12\x80\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"C\x92A&\x12\x11Create a new user\x1a\x11Create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12x\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\";\x92A\x1e\x12\rUpdate a user\x1a\rUpdate a user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12r\n" +
	...
	"\x0eSimpleBank API\"H\n" +
	"\x04Aroi\x12.https://github.com/grpc-ecosystem/grpc-gateway\x1a\x10none@example.com2\x031.2Z#github.com/MumAroi/go-simplebank/pbb\x06proto3"
