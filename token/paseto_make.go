...
func (m *PasetoMaker) CreateToken(username string, duration time.Duration) (string, *VerifiedPayload, error) {
...
func (m *PasetoMaker) VerifyToken(token string) (*VerifiedPayload, error) {
